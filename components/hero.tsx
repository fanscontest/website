    ...
    <section className="relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="pt-[10rem] md:pt-[11rem] pb-16 md:pb-24">
          <div className="md:grid md:grid-cols-12 md:gap-4 lg:gap-6 items-center">
              ...
              >
                ...
                >
                  ...
                  <div className="text-left">
                    <div className="text-[10px] text-slate-900 uppercase tracking-wide">Download on the</div>
                ...
                >
                  ...
                  <div className="text-left">
                    <div className="text-[10px] text-slate-900 uppercase tracking-wide">Get it on</div>
            ...
            {/* Phone mockup column */}
            <div
              className="md:col-span-4 flex justify-center md:justify-start md:-translate-y-[30px]"
              data-aos="fade-up"
              data-aos-delay="500"
            >
