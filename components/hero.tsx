  ...
  return (
    <section className="relative">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-[8rem] md:pt-[9.5rem] pb-24 md:pb-32">
            ...
            <div className="md:col-span-7 text-center md:text-left mb-16 md:mb-0">
              ...
              >
                <a
                  ...
                  className="inline-flex items-center gap-3 px-5 py-3 rounded-xl border border-purple-400/30 bg-slate-900 hover:bg-slate-800 transition"
                ...
                >
                  ...
                  <div className="text-left">
                    <div className="text-[10px] text-purple-200 uppercase tracking-wide">Download on the</div>
                ...
                >
                  ...
                  <div className="text-left">
                    <div className="text-[10px] text-purple-200 uppercase tracking-wide">Get it on</div>
