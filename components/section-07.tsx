              ...
              >
                ...
                <div className="relative flex flex-col h-full rounded-br-[100px] py-5 px-6">
                  ...
                  <div className="mb-5">
                    ...
                    <a className="btn-sm w-full inline-flex items-center text-purple-50 bg-purple-600 hover:bg-purple-700 shadow-xs" href="#0">
                      Get Starter
                    </a>
                  </div>
                ...
                {/* Pricing table 2 */}
                <div className="relative flex flex-col h-full bg-linear-to-b from-purple-100 to-purple-50 rounded-br-[100px] py-5 px-6">
                  ...
                  <div className="mb-5">
                    ...
                    <a className="btn-sm w-full inline-flex items-center text-slate-100 bg-slate-800 hover:bg-slate-900 shadow-xs" href="#0">
                      Get Smart
                    </a>
                  </div>
