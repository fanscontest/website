        ...
        <div className="py-12 md:py-20">
          <div className="sm:flex sm:flex-col lg:flex-row justify-between items-center">
            ...
            <div className="mb-6 lg:mr-16 lg:mb-0 text-center lg:text-left">
              ...
              <h2 className="h2 text-slate-100">Fans participate. Brands engage. Champions emerge.</h2>
            </div>
            ...
            <div className="shrink-0">
              <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center md:justify-start space-y-4 sm:space-y-0 sm:space-x-4 mb-12 md:mb-0">
                <div>
                  <a className="btn-sm w-full inline-flex items-center text-purple-50 bg-purple-600 hover:bg-purple-700 group shadow-xs" href="#">
                    Get the app
                ...
                <div>
                  <a
                    className="btn-sm w-full inline-flex items-center text-white bg-slate-700 hover:bg-slate-800 shadow-xs relative before:absolute before:inset-0 before:bg-purple-400/60 before:-z-10 before:rounded-full"
                    href="#"
                  >
                    Create a contest
                  </a>
