  ...
  return (
    <section data-aos-id-2="">
      <div className="relative max-w-7xl mx-auto">
        ...
        {/* Bg */}
        <div className="absolute inset-0 rounded-tr-[100px] mb-24 md:mb-0 bg-white pointer-events-none -z-10" aria-hidden="true" />
          ...
          <div className="pt-12 md:py-20">
            ...
            <div className="relative max-w-xl mx-auto md:max-w-none text-center md:text-left">
              ...
              <div className="md:max-w-lg">
                ...
                {/* Copy */}
                <h2 className="h2 text-slate-900 mb-4" data-aos="fade-up" data-aos-anchor="[data-aos-id-2]" data-aos-delay="100">
                ...
                <div className="flex max-w-md mx-auto md:mx-0 text-left" data-aos="fade-up" data-aos-anchor="[data-aos-id-2]" data-aos-delay="300">
                  ...
                  />
                  <div>
                    <blockquote className="text-slate-600 m-0">
              ...
              <div className="md:absolute md:right-0 md:top-1/2 md:-translate-y-1/2 -mb-12 mt-8 md:mt-0 md:mb-0 flex justify-center">
                <div className="relative max-w-[260px] sm:max-w-[300px]" data-aos="fade-up" data-aos-anchor="[data-aos-id-2]">
                  <Image
                    src={AppMockup}
