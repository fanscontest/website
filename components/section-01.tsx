        ...
        <div className="py-12 md:py-28 md:pb-20">
          ...
          <div className="max-w-sm mx-auto grid gap-12 md:grid-cols-3 md:-mx-9 md:gap-0 items-start md:max-w-none">
            ...
            >
                ...
                <svg width="56" height="56" xmlns="http://www.w3.org/2000/svg">
                  <defs>
                    <linearGradient x1="50%" y1="100%" x2="50%" y2="0%" id="a">
                      <stop stopColor="#760077" offset="0%" />
                      <stop stopColor="#AA1BA2" offset="100%" />
                    </linearGradient>
                  </defs>
              ...
              <h4 className="text-xl font-bold mb-1">From audience to participants</h4>
              <p className="text-slate-500">
                Traditional engagement is passive. Fans Contest turns fans into active participants who compete, create, and interact with your brand.
              </p>
            </div>
            ...
            >
              ...
              <h4 className="text-xl font-bold mb-1">Engagement fans choose</h4>
              <p className="text-slate-500">
                Instead of interrupting fans with ads, invite them into experiences they willingly join, enjoy, and share with friends.
              </p>
            </div>
            ...
            >
              ...
              <h4 className="text-xl font-bold mb-1">Real rewards. Real recognition.</h4>
              <p className="text-slate-500">
                Fans compete for meaningful rewards while brands gain authentic engagement and actionable insight. Everyone wins.
              </p>
            </div>
          </div>
        </div>
