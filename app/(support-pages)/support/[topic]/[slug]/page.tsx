    ...
    <div className="md:grow md:pl-[21rem]">
      <div className="pt-28 pb-12 md:pt-36 md:pb-16">
        ...
        <article>
          ...
          <div className="prose text-slate-500 font-[350] max-w-none prose-p:leading-normal prose-headings:text-slate-800 prose-a:text-purple-600 prose-a:font-[550] prose-a:no-underline hover:prose-a:underline">
