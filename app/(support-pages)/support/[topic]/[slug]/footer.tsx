    ...
    <footer className="pt-8 mt-8 border-t border-slate-200">
      <div className="flex items-center space-x-6">
        ...
        <div className="flex items-center space-x-2">
          <button className="btn-sm text-sm px-3 py-1.5 inline-flex items-center text-purple-50 bg-purple-600 hover:bg-purple-700 shadow-xs">
            <svg className="shrink-0 fill-purple-300 mr-2" width="12" height="13" xmlns="http://www.w3.org/2000/svg">
