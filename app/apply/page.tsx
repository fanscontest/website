            ...
            <div className="pt-36 pb-12 md:pt-40 md:pb-20">
              <div className="lg:flex lg:space-x-12 xl:space-x-16">
                ...
                <div className="relative shrink-0 text-center lg:text-left">
                  {/* Bg */}
                  <div
                    className="absolute inset-0 mb-44 -mx-4 sm:-mx-6 lg:-mt-[9999px] lg:ml-0 lg:-mr-[9999px] rounded-bl-[100px] bg-linear-to-tr from-purple-700 to-purple-600 pointer-events-none -z-10"
                    aria-hidden="true"
                  />
                    ...
                    <div className="w-full max-w-[480px] mx-auto lg:w-[480px] lg:max-w-none lg:mx-0 xl:w-[512px] bg-white p-6 shadow-2xl">
                      ...
                      <form>
                        ...
                        <div className="mt-6 text-right">
                          <button className="btn-sm inline-flex items-center text-purple-50 bg-purple-600 hover:bg-purple-700 group shadow-xs">
                            Submit the form
                          </button>
                        </div>
                      </form>
