...
summary: How Fans Contest collects, uses, and protects your personal information.
...
This Policy is a legally binding agreement between you (“User”, “you” or “your”) and Ivory Tech UG (haftungsbeschränkt) (doing business as “Ivory Tech”, “we”, “us” or “our”). If you are entering into this agreement on behalf of a business or other legal entity, you represent that you have the authority to bind such entity to this agreement, in which case the terms “User”, “you” or “your” shall refer to such entity. If you do not have such authority, or if you do not agree with the terms of this agreement, you must not accept this agreement and may not access and use the Services. By accessing and using the Services, you acknowledge that you have read, understood, and agree to be bound by the terms of this Policy. This Policy does not apply to the practices of companies that we do not own or control, or to individuals that we do not employ or manage.
...
Information collected through Reddit
...
Some of our Services are offered as a Reddit application that runs inside Reddit communities (subreddits). When you interact with these Services on Reddit — for example, by joining or submitting predictions in a prediction contest — we receive from Reddit a limited set of information about you:

Your Reddit account identifier (the stable “t2_” user ID assigned by Reddit)

Your public Reddit username and display name

We do not receive your Reddit password, email address, or other Reddit account credentials. We use this information solely to create and resolve a participant identity on our contest platform, to record and score the predictions you submit, to determine contest results and standings, and to show you your own results within the Service. Results and any prizes are made available to you within the Service; we do not send you Reddit direct messages as part of operating a contest.

To operate these Services, we share your Reddit account identifier and username with our contest platform provider, which processes them on our behalf and on our instructions as described in the “Disclosure of information” section below. We do not sell this information or use it for advertising.
...
We may use cookies to collect, store, and track information for security and personalization, to operate the Services, and for statistical purposes. For further information on the cookies we collect and their purpose, see our
cookie policy
